# os.stat - informações do arquivo 
# data de modificação, permissões, data de criação

# Seu código pode melhorar - stackoberflow
import math
import os
...
for root, dirs, files in os.walk(caminho):
    ...
    for file_ in files:
        caminho_completo_arquivo = os.path.join(root, file_) #nome do arquivo
        # tamanho = os.path.getsize(caminho_completo_arquivo) #tamanho do arquivo
        stats = os.stat(caminho_completo_arquivo) #informações do arquivo
        tamanho = stats.st_size #tamanho do arquivo
        print('  ', the_counter, 'FILE:', file_, formata_tamanho(tamanho)) #converte o tamanho
